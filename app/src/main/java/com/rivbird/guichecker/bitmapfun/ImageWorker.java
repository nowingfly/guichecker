...
public abstract class ImageWorker {
    ...
    public void loadImageFromFile(String path, ImageView imageView) {
        if (path == null) {
            return;
        }
        ...
        if (value != null) {
            ...
            task.executeOnExecutor(AsyncTask.DUAL_THREAD_EXECUTOR, ImageFetcher.FILE_TYPE);
     ...
     * @param cacheParams The cache parameters to use for the image cache.
     */
    public void addImageCache(android.app.FragmentManager fragmentManager, ImageCache.ImageCacheParams cacheParams) {
        mImageCacheParams = cacheParams;
        mImageCache = ImageCache.getInstance(fragmentManager, mImageCacheParams);
        new CacheAsyncTask().execute(MESSAGE_INIT_DISK_CACHE);
    }
    ...
    protected abstract Bitmap processBitmap(Object data, int resType);
    ...
    private class BitmapWorkerTask extends AsyncTask<Integer, Void, BitmapDrawable> {
        ...
        protected BitmapDrawable doInBackground(Integer... params) {
            ...
            int resType = ImageFetcher.HTTP_TYPE;
            ...
            if (bitmap == null && !isCancelled() && getAttachedImageView() != null && !mExitTasksEarly) {
                bitmap = processBitmap(mData, resType);
            }
